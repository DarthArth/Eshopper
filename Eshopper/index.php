...
<head>
    ...
    <meta name="Dylan Gonzalez" content="">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="agregarproductos.php" target="_blank"><i Desarrollo De Software WEB class="fa fa-plus"></i>Agregar</a></li>
					...
					<div class="recommended_items"><!--recommended_items-->
						...
						<div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner">
								...
								<div class="single-products">
								<div class="productinfo text-center">
								<img src="images/home/110.jpg" alt="" />
								<h2>$720</h2>
								<p>Lego casa rodante</p>
								<a href="#" class="btn btn-default-add-to-cart"><i class ="fa fa-shopping-cart"></i> Agregar al Carrito</a>
								</div>
								...
								<div class="single-products">
								<div class="productinfo text-center">
								<img src="images/home/120.jpg" alt="" />
								<h2>$1</h2>
								<p>Calzones de Cerati</p>
								<a href="#" class="btn btn-default-add-to-cart"><i class ="fa fa-shopping-cart"></i> Agregar al Carrito</a>
								</div>
								...
								<div class="single-products">
								<div class="productinfo text-center">
								<img src="images/home/132.jpg" alt="" />
								<h2>$400</h2>
								<p>Mascara de Gas</p>
								<a href="#" class="btn btn-default-add-to-cart"><i class ="fa fa-shopping-cart"></i> Agregar al Carrito</a>
								</div>
